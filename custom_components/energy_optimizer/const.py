...
CONF_EVENING_SECOND_MAX_PRICE_HOUR_SENSOR = "evening_second_max_price_hour_sensor"
...
CONF_BEV_CHARGING_BINARY_SENSOR = "bev_charging_binary_sensor"
CONF_BEV_CHARGING_POWER_SENSOR = "bev_charging_power_sensor"
CONF_GRID_CHARGE_CURRENT_ENTITY = "grid_charge_current_entity"
...
DEFAULT_MIN_SOC = 15
DEFAULT_MIN_SOC_PV = 15
DEFAULT_MAX_SOC = 100
DEFAULT_BALANCING_INTERVAL_DAYS = 14
DEFAULT_BALANCING_PV_THRESHOLD = 20.5
DEFAULT_MAX_CHARGE_CURRENT = 32
DEFAULT_PV_EFFICIENCY = 0.9
DEFAULT_MIN_ARBITRAGE_PRICE = 0.0
DEFAULT_MORNING_SELL_PV_COVERAGE_MARGIN = 0.5
DEFAULT_EXPORT_BLOCK_OFFGRID_THRESHOLD = 3.5
